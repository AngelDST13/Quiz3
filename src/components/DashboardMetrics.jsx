    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
        <div style={{ background: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          ...
          <p style={{ fontSize: '20px', fontWeight: 'bold', color: '#0f172a' }}>{formatMoney(stats.total)}</p>
        </div>
        <div style={{ background: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
        ...
        <div style={{ background: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          ...
          <p style={{ fontSize: '20px', fontWeight: 'bold', color: '#0f172a' }}>{formatMoney(stats.avg)}</p>
        </div>
        <div style={{ background: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          <h4 style={{ color: '#64748b', fontSize: '13px' }}>Proyección Siguiente Período</h4>
          <p style={{ fontSize: '20px', fontWeight: 'bold', color: '#16a34a' }}>{formatMoney(stats.projection)}</p>
